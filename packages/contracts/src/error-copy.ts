...
const copy: Record<ErrorCode, string> = {
  ...
  WALLET_CHALLENGE_NOT_FOUND: 'Start the wallet sign in again, then approve it in your wallet.',
  WALLET_CHALLENGE_EXPIRED: 'The sign in request expired. Start it again.',
  WALLET_CHALLENGE_USED: 'That sign in request was already used. Start a new one.',
  WALLET_SIGNATURE_INVALID: 'The signature did not match the wallet. Try again.',
