...
| `docs/14-state-machines.md` | Every status graph, its transitions and effects, as documented and as coded |
| `docs/15-deployment.md` | Supabase, Render and Vercel: taking the demo live, step by step |
