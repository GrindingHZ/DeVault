...
/* Demo defaults from docs/OPEN-QUESTIONS.md: holding period 30 days and rate
   cap 4800 (Q-001), loan to value by category (Q-003), a dual appraisal threshold
...
export const demoParameters: ProtocolParameters = {
  /* Priced by how fast and how certainly a liquidator can turn the thing back
     into money. Bullion is spot priced and sells the same day; an appraisal of
     a painting is an opinion, so we lend against much less of it. */
