...
export function LandingLiquidity(): ReactElement {
  ...
  return (
    /* Not pinned. The content grew past a screen once it had a lede and a
       worked example in it, and a sticky box is exactly one screen tall, so
       the overflow sat under the next section and its ground line cut across
       the last row. In normal flow it owns its area and the bars animate as
       it arrives instead. */
    <section ref={section} className="scroll-mt-24 border-t border-edge bg-surface-base py-[8rem]">
