...
- [x] feat(events): attest every domain event in the transaction that caused it (landed inside the lifecycle test commit after the hook refused a 74 character header)
...
- [x] test(api): pausing on chain blocks holds and never blocks refunds
